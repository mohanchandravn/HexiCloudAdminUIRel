   ...
   */
        ...
        target: {
          options: {
            ...
            war_name: 'hexiCloudAdmin'            /* War name for Prod and Test */
//                       war_name: 'hexiCloudAdminDev'            /* War name for Dev */
...
//                                          /* some extra settings for web.xml to work with JCS-SX */
          ...
          files: [
            {
              expand: true,
              cwd: 'web',             /* find the source files for the WAR in the /release folder */
              src: ['**'],
              dest: ''
            }
          ]
